...
# Removed: from . import internal_bp
...
# Define a function to register routes on a blueprint
def register_internal_routes(bp):
    ...
    def landing_page():
        ...
        nav_items = [
            ...
            {'name': 'Device Management', 'url': '.devices_list', 'requires_sudoer': False}
            # Add more tools here
        ]
        ...
        if request.method == 'POST':
            ...
            if error:
                return render_template('internal_app/device_form.html', 
                                       ...
                                       form_action_url=url_for('.add_device'))
    ...
    @bp.route('/devices/edit/<mac_address_display>', methods=['GET', 'POST'])
    @require_sudoer
        ...
        if request.method == 'POST':
            ...
            if error:
                ...
                return render_template('internal_app/device_form.html', 
                                       ...
                                       valid_vlan_names=VALID_VLAN_NAMES,
                                       form_action_url=url_for('.edit_device', mac_address_display=mac_address_display))
    ...
    @bp.route('/devices/delete/<mac_address_display>', methods=['POST'])
    @require_sudoer
...
# End of register_internal_routes function
